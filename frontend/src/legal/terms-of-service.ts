...
2. 계정 삭제 시 개인정보는 개인정보처리방침이 정한 바에 따라 처리되며, 법령상 보존 의무가 있는 기록과 이 약관에 대한 동의 사실을 증명하기 위해 별도로 보관하는 기록은 해당 기간 동안 보존됩니다. 동의 이력은 서비스 운영에 사용하는 표에서 분리한 전용 보관 표에 6개월간 보관한 뒤 파기하며, 자세한 내용은 개인정보처리방침 제3조 3항에 따릅니다.
