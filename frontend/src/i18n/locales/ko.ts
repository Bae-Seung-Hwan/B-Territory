export const ko = {
  ...
  auth: {
    ...
    emailVerification: {
      hint: '가입하려면 이메일 인증이 필요합니다. 인증 메일의 링크를 누른 뒤 가입하기를 눌러주세요.\n이미 인증을 마쳤다면 메일을 다시 받지 않아도 됩니다.',
      send: '인증 메일 발송',
      resendIn: '{{seconds}}초 후 재발송 가능',
      sentTitle: '인증 메일 발송',
      sentMessage: '메일함을 확인해 인증 링크를 눌러주세요.\n인증을 마친 뒤 가입하기를 누르면 됩니다. (링크는 10분간 유효)',
      sendFailed: '인증 메일 발송에 실패했습니다.',
      verifyingTitle: '이메일 인증 중',
      successTitle: '이메일 인증 완료',
      successMessage: '인증이 완료되었습니다.\n앱으로 돌아가 가입을 마무리해주세요.',
      failedTitle: '이메일 인증 실패',
      failedMessage: '유효하지 않거나 만료된 링크입니다.\n인증 메일을 다시 요청해주세요.',
      missingToken: '인증 토큰이 없는 주소입니다.\n메일의 링크를 그대로 열어주세요.',
      goToRegister: '가입 화면으로',
    },
    errors: {
      title: '오류',
