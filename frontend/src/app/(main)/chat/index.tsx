...
export default function ChatScreen() {
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
      {/*
        이용자 보호 주의·제재 안내(원스토어 반려 사유 3번). 공지는 고정 노출이
        어려우면 스크롤링도 허용한다. 이 앱은 지속적으로 안내하기 위해 목록의
        ListHeaderComponent 대신 화면 상단 고정을 선택했다 — 헤더로 넣으면 대화가 쌓이는 즉시 스크롤 밖으로 밀려 사라진다.
