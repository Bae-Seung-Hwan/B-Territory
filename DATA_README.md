...
| festivals.xls | 축제 및 행사 데이터 | 45 |
| visitor_stats_long.xls | 관광 통계 long-format 데이터 | 962 |
| code_tables.xls | 지역코드/분류코드 참고표 | 50 |
| missing_detail_report.xls | 누락값 상세 리포트 | 15 |
...
- `festivals.xls`는 기간 한정 미션이나 이벤트 추천 화면에 사용
- `visitor_stats_long.xls`는 발표 자료의 관광 트렌드 분석과 추천 근거로 사용
...
| 축제 기능 | festivals.xls | 축제 리스트, 기간 한정 이벤트 |
| 분석/발표 | visitor_stats_long.xls | 통계 시각화, 공모전 발표 근거 |
