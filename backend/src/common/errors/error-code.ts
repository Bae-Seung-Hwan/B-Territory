...
export enum ErrorCode {
  ...
  // 상대가 직전 결투를 거절해 보호 기간 중인 경우.
  DUEL_TARGET_SHIELDED = 'DUEL_TARGET_SHIELDED',
  DUEL_OUT_OF_RANGE = 'DUEL_OUT_OF_RANGE',
  DUEL_ALREADY_ACTIVE = 'DUEL_ALREADY_ACTIVE',
  DUEL_ALREADY_PENDING = 'DUEL_ALREADY_PENDING',
  // 같은 requestId를 다른 상대에게 다시 쓴 경우. 재시도가 아니라 클라이언트 버그다.
  DUEL_REQUEST_ID_REUSED = 'DUEL_REQUEST_ID_REUSED',
