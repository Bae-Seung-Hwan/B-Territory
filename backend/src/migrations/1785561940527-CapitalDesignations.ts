...
export class CapitalDesignations1785561940527 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "capital_designations" ("id" SERIAL NOT NULL, "sigunguCode" character varying NOT NULL, "designatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_1fb5e5b6417fa8be7f18098323d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
